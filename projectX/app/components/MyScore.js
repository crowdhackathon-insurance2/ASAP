...
export default class MyScore extends Component {
  ...
  render() {
	...
	<View style = {styles.container}>
		...
		<TouchableOpacity onPress={this.showBadges} style = {styles.spbuttonContainer}>
                        <Text style={styles.SText}>My Badges</Text>
                    </TouchableOpacity>
                
		
                <View style = {styles.inputContainer} >
		<Text style = {styles.SText}> {this.state.username}, your score is {this.state.score} </Text>
